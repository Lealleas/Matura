...
var RevealMenu = window.RevealMenu || (function(){
	...
	loadResource(options.path + '/menu.min.css', 'stylesheet', function() {
		...
		if (!bowser.msie || bowser.version >= 9) {
			...
			if (typeof themes === "undefined") {
				themes = [
					...
					{ name: 'White', theme: 'css/theme/white.min.css' },
			...
			$('<li data-panel="Slides"><span class="slide-menu-toolbar-label">Library Quickstart</span><br/><i class="fa fa-list"></i></li>')
				.appendTo(toolbar)
			...
			if (openButton) {
				// add menu button
				$('<div id="quickstartmenu" class="slide-menu-button"><a href="#"><span class="menu-scale fa-stack"><i class="fa fa-circle fa-stack-2x inner-circle-color"></i><i class="fa fa-circle-thin fa-stack-2x outer-circle-color"></i><i class="fa fa-bars fa-stack-1x burger-color"></i></span></a></div>')
					.appendTo($('.reveal'))
					.click(openMenu);
			}
